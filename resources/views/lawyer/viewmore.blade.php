                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <!-- database colum name -->
                                                        <td>{{$more->id}}</td>
                                                        <td> <img src="/images/{{$more->image}}" width="80px" alt=""> </td>
                                                        <td>{{$more->name}}</td>
                                                        <td>{{$more->law}}</td>
                                                        <td>{{$more->paragraph}}</td>
                                                        <td><a href="{{route('more.edit',$more->id)}}" class="btn" id="upd">update</a></td>
                                                        <!-- delete work -->
                                                        <td>
                                                            <form action="{{route('more.destroy',$more->id)}}" method="post">
                                                                @csrf
                                                                @method('DELETE')
