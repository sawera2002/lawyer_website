			...
			<div class="content-wrapper">
				...
				<section class="content-header">					
					<div class="container-fluid">
						<div class="row mb-2">
							<div class="col-sm-6">
								<h1 style="background-image: url('/img/adminbanner.jpg');height: 300px;width: 1083px;padding-top:26%;text-decoration:underline;font-weight:bolder;" class="text-center " >Political Update</h1>
							</div>
							<div class="col-sm-6">
                                                    ...
                                                    <form action="{{route('poly.update',$poly->id)}}" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="row ">
                                                            ...
                                                            <div class="col">
																...
																<br>
                                                                <img src="/images/{{$poly->image}}" width="100px" alt="">
                                                            </div>
                                                        </div>
														<br>
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                <input type="text" name="name" value="{{$poly->name}}" class="form-control" />
                                                            </div>
                                                        </div>
<br>
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                <input type="text" name="law" value="{{$poly->law}}" class="form-control" />
                                                            </div>
                                                        </div>
														<br>
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                <input type="text" name="paragraph" value="{{$poly->paragraph}}" class="form-control" />
                                                            </div>
                                                        </div>
