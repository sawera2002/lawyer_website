			...
			<div class="content-wrapper">
				...
				<section class="content-header">					
					<div class="container-fluid">
						<div class="row mb-2">
							<div class="col-sm-6">
								<h1 style="background-image: url('/img/adminbanner.jpg');height: 300px;width: 1083px;padding-top:26%;text-decoration:underline;font-weight:bolder;" class="text-center " >Update Business</h1>
							</div>
							<div class="col-sm-6">
                                        ...
                                        <div class="col-md-9">
													...
													<form action="{{ route('businesses.update', $business->id) }}" method="POST" enctype="multipart/form-data">
														...
														<div class="row">
															...
															<div class="col">
																...
																<img src="/images/{{ $business->image }}" width="100px" alt="">
															</div>
														</div>
														<br>
														<div class="row">
													...
													<br>
														<div class="row">
															...
															<div class="col">
																<input type="text" name="law" value="{{ $business->law }}" class="form-control" />
															</div>
														</div>
														<br>
														<div class="row">
															...
															<div class="col">
																<input type="text" name="paragraph" value="{{ $business->paragraph }}" class="form-control" />
															</div>
														</div>
														<br>
														<div class="row">
