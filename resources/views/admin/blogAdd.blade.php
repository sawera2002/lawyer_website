                            ...
                            <div class="col-md-9">
                                ...
                                <div class="text-center">
                                    <!-- <h3>LAWYERS INSERT</h3> -->
                                                ...
                                                <div class="text-center">
                                                    <h1 style="background-image: url('img/adminbanner.jpg');height: 300px;width: 1083px;padding-top:18%;text-decoration:underline;font-weight:bold;" class="text-center ">Blog Data</h1>
                                                </div>
