                                                ...
                                                <div class="text-center">
                                                    ...
                                                    <form action="{{route('feature.store')}}" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" name="paragraph2" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" name="paragraph3" class="form-control" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row mb-3">
                                                            <div class="col-sm-10">
                                                                <button class="btn text-center" type="submit">INSERT FEATURED</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                            </div>
